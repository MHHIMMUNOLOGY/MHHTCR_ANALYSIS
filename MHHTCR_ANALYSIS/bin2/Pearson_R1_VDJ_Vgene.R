...
colnames(FILE1)[which(names(FILE1) == "V.gene")] <- "V2"
colnames(FILE1)[which(names(FILE1) == "Read.count")] <- "V1"
colnames(FILE2)[which(names(FILE2) == "V.gene")] <- "V2"
...
if(nrow(DIFF_FILE1_FILE2) != 0) {DIFF_FILE1_FILE2$Freq2 <- 0}
if(nrow(DIFF_FILE2_FILE1) != 0) {DIFF_FILE2_FILE1$Freq2 <- 0}
...
if(nrow(DIFF_FILE1_FILE2) != 0) {DIFF_FILE1_FILE2 <- DIFF_FILE1_FILE2[,c(1,3,2)]}
