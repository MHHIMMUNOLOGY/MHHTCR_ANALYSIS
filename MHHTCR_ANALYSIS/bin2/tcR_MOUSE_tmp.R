...
# Read files
FILENAME1YESNO <- exists("FILENAME1")
FILE1 <- parse.vdjtools(FILENAME1)
FILENAME2YESNO <- exists("FILENAME2")
FILE2 <- parse.vdjtools(FILENAME2)
FILENAME3YESNO <- exists("FILENAME3")
FILE3 <- parse.vdjtools(FILENAME3)
FILENAME4YESNO <- exists("FILENAME4")
FILE4 <- parse.vdjtools(FILENAME4)
FILENAME5YESNO <- exists("FILENAME5")
FILE5 <- parse.vdjtools(FILENAME5)
FILENAME6YESNO <- exists("FILENAME6")
FILE6 <- parse.vdjtools(FILENAME6)
FILENAME7YESNO <- exists("FILENAME7")
FILE7 <- parse.vdjtools(FILENAME7)
FILENAME8YESNO <- exists("FILENAME8")
FILE8 <- parse.vdjtools(FILENAME8)
FILENAME9YESNO <- exists("FILENAME9")
FILE9 <- parse.vdjtools(FILENAME9)
FILE10 <- parse.vdjtools(FILENAME10)
FILE10 <- parse.vdjtools(FILENAME10)

# Make a list of all files that come from one experiment
Experiment <- list("1CUTSR62" = FILE1, "2MIXCR_SR62" = FILE2, "3SR62_IMGT" = FILE3, "4SR62_200" = FILE4, "5SR62_150" = FILE5)
#
