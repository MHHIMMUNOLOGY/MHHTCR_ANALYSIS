...
for diversitystats in $VDJRESULTS/VDJTOOLS_*
do
  java -Xmx4G -jar $VDJDIR CalcDiversityStats $diversitystats CalcDiversityStats_`basename $diversitystats`
done

if [ ! -d $VDJRESULTS/DiversityStats ]; then mkdir -p $VDJRESULTS/DiversityStats; fi;

mv *CalcDiversityStats* $VDJRESULTS/DiversityStats
