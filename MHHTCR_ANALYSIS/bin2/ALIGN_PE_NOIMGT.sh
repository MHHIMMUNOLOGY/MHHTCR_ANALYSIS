...
do
  mixcr align -OmergerParameters.minimalOverlap=17 -OmergerParameters.minimalIdentity=0.9 -r $VDJRESULTS/reportALIGN_`basename $SAMPLE1`.txt -s $SPECIES -c $LOCI -nw $SAMPLE `basename $SAMPLE`.vdjca
